...
export const LEVELS = [
  {
    name: 'Recrue',     emoji: '🎖️',  min: 0,
    color: '#8892A8',
    gradient: ['#C8CDD8', '#9298A8', '#B4B9C6', '#72788A'],
  },
  {
    name: 'Gardien',    emoji: '🥈',  min: 500,
    color: '#8090AC',
    gradient: ['#E0E5F0', '#9BA6BE', '#CDD4E4', '#8090AC'],
  },
  {
    name: 'Brigadier',  emoji: '🥇',  min: 1500,
    color: '#C09000',
    gradient: ['#FFE566', '#C09000', '#FFD020', '#A07800'],
  },
  {
    name: 'Officier',   emoji: '💎',  min: 3000,
    color: '#006DBF',
    gradient: ['#5CC8FF', '#006DBF', '#38AAEE', '#004A90'],
  },
  {
    name: 'Commandant', emoji: '🏆',  min: 6000,
    color: '#C03800',
    gradient: ['#FFB060', '#C03800', '#FF7020', '#901800'],
  },
];
